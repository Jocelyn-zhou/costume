...
{
    $sessionid=isset($_SESSION[MEMBER_WECHATRED])?$_SESSION[MEMBER_WECHATRED]:"";
...
//微信授权
function Oauth(){
    \LaneWeChat\Core\WeChatOAuth::getCode('oauth.php?url='.CurPageURL(), $state=1, $scope='snsapi_base');//snsapi_base
}
//生成二维码，返回图片地址
//$sceneId 非0整数
